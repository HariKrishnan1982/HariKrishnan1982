...
CSE student specializing in Cyber Security, focused on building, breaking, and defending systems.
...
| Project | Description |
|---|---|
| 🍪 **[Cookie_Autopsy](https://github.com/HariKrishnan1982/Cookie_Autopsy)** | Chrome extension for privacy transparency — classifies cookies & scores risk |
| 🔍 **[CommentAnalyzer-extension](https://github.com/HariKrishnan1982/CommentAnalyzer-extension_v001)** | Real-time sentiment analysis on YouTube/Reddit/Amazon/Flipkart comments |
| 📄 **Platen** | A Dart-based document scanner |
| 🛠️ **[P4tchW0rk-s_Tools-](https://github.com/HariKrishnan1982/P4tchW0rk-s_Tools-)** | Personal collection of Shell-based security & automation tools |
| 🎨 **[Roll_](https://github.com/HariKrishnan1982/Roll_)** | CSS-based project |
...
🧪 Preparing to build security-focused tools

**Training mindset:** Learn → Build → Break → Defend → Repeat
